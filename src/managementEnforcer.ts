...
export class ManagementEnforcer extends InternalEnforcer {
   ...
   * @param newRule the policy will be added
   */
  public async updatePolicies(oldRule: string[][], newRule: string[][]): Promise<boolean> {
    return this.updateNamedPolicies('p', oldRule, newRule);
  }
   ...
   * @return succeeds or not.
   */
  public async updateNamedPolicies(ptype: string, oldRule: string[][], newRule: string[][]): Promise<boolean> {
    return this.updatePoliciesInternal('p', ptype, oldRule, newRule);
  }
